...
class AirportSerializer(serializers.ModelSerializer):
    ...
    flight_destination = RunwaySerializer(many = True, read_only = True)
    runways = serializers.PrimaryKeyRelatedField(many = True, read_only = True)

    class Meta:
        model = Airport
        fields = ['name', 'airport_code']
        read_only_fields = ['id']
